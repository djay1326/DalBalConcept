...
namespace Dal
{
    public partial class HelperlandContextData : IdentityDbContext<Users, IdentityRole<int>, int>
    {
        public HelperlandContextData()
        {
        }

        public HelperlandContextData(DbContextOptions<HelperlandContextData> options)
            : base(options)
        {
        }
